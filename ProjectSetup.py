...
class ProjectMetadataHandler(ProjectConfig):
    ...
    METADATA_TEMPLATE = {
        "ProjectName": ["PythonProjectTemplate"],
        "LinkProjectRepo": ["https://github.com/pira245/PythonProjectTemplate"],
        "ImageName": ["PythonProjectTemplate.png"],
        "LinkImageRepo": ["https://github.com/pira245/PythonProjectTemplate/docs/media"],
        "Category": ["Template-Python-Project"],
...
class ProjectDataHandler(ProjectConfig):
    ...
    DATA_TEMPLATE = {
        ...
        "Value": [
            ...
            "https://github.com/pira245/PythonProjectTemplate", 
            ...
            "https://github.com/pira245/PythonProjectTemplate/docs/media/screenshot-1.png", 
            "https://github.com/pira245/PythonProjectTemplate/docs/media/screenshot-2.png", 
            "https://github.com/pira245/PythonProjectTemplate/docs/media/screenshot-3.png", 
