...
#------------------------------------------------------------------------------
# ServerApp(JupyterApp) configuration - Can be modified: 21.03.2025
#------------------------------------------------------------------------------
...
#  Default: '/'
c.ServerApp.base_url = '/machine-learning/'
...
## The default URL to redirect to from `/`
#  Default: '/'
c.ServerApp.default_url = '/jnote-learning-env/'
...
#  local as well.
#  Default: ['localhost']
#c.ServerApp.local_hostnames = ['127.0.0.1']
...
## Instead of starting the Application, dump configuration to stdout
#  See also: Application.show_config
#c.ServerApp.show_config = True

## Instead of starting the Application, dump configuration to stdout (as JSON)
#  See also: Application.show_config_json
#c.ServerApp.show_config_json = True
